...
def bootstrap_phase1(config_module=None):
    """
...
# Note: As you refactor Phase 2, Phase 3, etc., you will add
# bootstrap_phase2(), bootstrap_phase3() here following the exact same DI pattern.